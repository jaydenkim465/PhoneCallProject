...
import com.jaydenkim465.phonecallproject.adapter.AdapterRankList
import com.jaydenkim465.phonecallproject.data.RankData
	...
	override fun onCreateView(
		...
		if (view is RecyclerView) {
			with(view) {
				...
				adapter = AdapterRankList(RankData.ITEMS)
			}
		}
		return view
	}
